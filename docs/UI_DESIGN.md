...
| Toolbar | A row under the title bar, right of the portrait: a search slot (Summary's item search, or the Reputation / Guild tab's own filter), the active tab's settings button, and the search-mode checkboxes. |
